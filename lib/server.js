...
server.unifiedServer = (req, res) => {
  ...
  req.on('end', () => {
    ...
    choosendHandler =
      trimmedPath.indexOf('public/') > -1 ? handlers.public : choosendHandler;
    ...
    choosendHandler(data, (statusCode, payload, contentType) => {
      ...
      if (contentType == 'html') {
        ...
        payloadString = typeof payload == 'string' ? payload : ''; // We only be able to write string to the body of the html file
      }
